...
/*	 local_loop{
    ...
    local_loop{
        new_position[pIDX][0] = (1.0 + DisGrad[pIDX][0][0])*(px+lxs) + DisGrad[pIDX][0][1]*(py) + DisGrad[pIDX][0][2]*(pz); 
        new_position[pIDX][1] = (1.0 + DisGrad[pIDX][1][1])*(py) + DisGrad[pIDX][1][0]*(px+lxs) + DisGrad[pIDX][1][2]*(pz); 
        new_position[pIDX][2] = (1.0 + DisGrad[pIDX][2][2])*(pz) + DisGrad[pIDX][2][0]*(px+lxs) + DisGrad[pIDX][2][1]*(py); 
    } 
