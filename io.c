...
//MPI_Address(&value.jgr, &indices[0]);
	...
	//	tmpVector[pIDX].jgr = grain_f[pIDX];
		//tmpVector[pIDX].jph = phase_f[pIDX];
                tmpVector[pIDX].SS1 =new_position[pIDX][0] +  displacement_fluct[pIDX][0] - (px+lxs) ;
                tmpVector[pIDX].SS2 =new_position[pIDX][1] +  displacement_fluct[pIDX][1] - py ;
                tmpVector[pIDX].SS3 = new_position[pIDX][2] +  displacement_fluct[pIDX][2] -pz ;
